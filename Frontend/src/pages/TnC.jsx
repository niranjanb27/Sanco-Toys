...
import { FaFileContract } from 'react-icons/fa'; // import the icon

const TnC = () => {
  return (
    <div className="min-h-screen bg-black px-6 py-16 animate-fade-in-up">
      ...
      <h1 className="text-5xl font-bold text-red-500 mb-10 text-center flex items-center justify-center gap-4 animate-fade-in-up delay-[200ms]">
        ...
        <div className="text-lg text-green-200 leading-8 space-y-6 animate-fade-in-up delay-[300ms]">
          <p>
          ...
          <h2 className="text-3xl font-semibold text-red-200 mb-4">1. Use of Website</h2>
          <p>
          ...
          <h2 className="text-3xl font-semibold text-red-200 mb-4">2. Product Information</h2>
          <p>
          ...
          <h2 className="text-3xl font-semibold text-red-200 mb-4">3. Orders & Payment</h2>
          <p>
          ...
          <h2 className="text-3xl font-semibold text-red-200 mb-4">4. Shipping & Delivery</h2>
          <p>
          ...
          <h2 className="text-3xl font-semibold text-red-200 mb-4">5. Returns & Refunds</h2>
          <p>
          ...
          <h2 className="text-3xl font-semibold text-red-200 mb-4">6. Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-3xl font-semibold text-red-200 mb-4">7. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-3xl font-semibold text-red-200 mb-4">8. Changes to Terms</h2>
          <p>
          ...
          <h2 className="text-3xl font-semibold text-red-200 mb-4">9. Contact Us</h2>
          <p>
